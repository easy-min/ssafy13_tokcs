...
import tokcs.apps.question.models.chapter
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='chapter',
            name='topic',
            field=models.ForeignKey(default=tokcs.apps.question.models.chapter.get_default_topic, on_delete=django.db.models.deletion.CASCADE, related_name='chapters', to='question.topic', verbose_name='주제'),
        ),
